					...
					<div class="row">
						<div class="col-md-3 col-sm-6 col-xs-12">
							<div class="category-dropdown">
								<h2 class="title-cat-dropdown">categories</h2>
									...
									<ul class="list-cat-dropdown">
										...
										<li>
											<div class="info-cat-dropdown">
                                                <h3><a href="{{ route('listing', ['category_id' => $data->id ]) }}">{{ $data->category }}</a></h3>
											</div>
										</li>
                                        @endforeach
									</ul>
							...
							<div class="deals-off">
								...
								<div class="deals-off-content">
									<div class="item-product item-product-list">
										<div class="item-product-thumb">
											<a class="item-product-link" href="#">
												<img alt="" src="images/home_3/deal1.png">
											</a>
										</div>
									...
									<div class="item-product item-product-list">
										<div class="item-product-thumb">
											<a class="item-product-link" href="#">
												<img alt="" src="images/home_3/deal2.png">
											</a>
										</div>
										<div class="item-product-info">
											<h3><a href="#">Chemise SLimFon</a></h3>
									...
									<div class="item-product item-product-list">
										<div class="item-product-thumb">
											<a class="item-product-link" href="#">
												<img alt="" src="images/home_3/deal3.png">
											</a>
										</div>
										<div class="item-product-info">
											<h3><a href="#">Chemise SLimFon</a></h3>
							...
							<div class="content-tab-product single-arrow">
								<div class="wrap-item">
									<div class="item">
										<div class="item-product product-lower">
											<div class="item-product-thumb item-thumb-product">
												<a href="#"><img alt="" src="images/home_3/tab1.png"></a>
									...
									<div class="item">
										<div class="item-product product-lower">
											<div class="item-product-thumb item-thumb-product">
												<a href="#"><img alt="" src="images/home_3/tab2.png"></a>
												<div class="info-product-cart">
													<div class="inner-info-product-cart">
														<ul>
															<li><a href="#" class="link-wishlist"><i class="fa fa-heart"></i></a></li>
									...
									<div class="item">
										<div class="item-product product-lower">
											<div class="item-product-thumb item-thumb-product">
												<a href="#"><img alt="" src="images/home_3/tab4.png"></a>
												<div class="info-product-cart">
													<div class="inner-info-product-cart">
														<ul>
															<li><a href="#" class="link-wishlist"><i class="fa fa-heart"></i></a></li>
						...
						<div role="tabpanel" class="tab-pane" id="featured">
							<div class="content-tab-product single-arrow">
								<div class="wrap-item">
									...
									<div class="item">
										<div class="item-product product-lower item-thumb-product">
											<div class="item-product-thumb">
												<a href="#"><img alt="" src="images/home_3/tab2.png"></a>
												<div class="info-product-cart">
													<div class="inner-info-product-cart">
										...
										<div class="list-title-tab-category">
											<ul class="nav nav-tabs" role="tablist">
                                                @foreach ($subCategory->where('category_id', 1) as $item)
												    <li role="presentation" class="active"><a href="{{ route('listing', ['sub_category_id' => $item->id]) }}" aria-controls="men1" role="tab" data-toggle="tab">{{ $item->sub_category }}</a></li>
                                                @endforeach
											</ul>
										</div>
									</div>
				...
				<div class="container">
					<div class="inner-category-tab-slider">
						<div class="row">
							<div class="col-md-4 col-sm-4 col-xs-12">
								<div class="sidebar-category-tab">
									<h2 class="title-category-tab">women’s</h2>
									<div class="clearfix">
										...
										<div class="list-title-tab-category">
											<ul class="nav nav-tabs" role="tablist">
                                                @foreach ($subCategory->where('category_id', 2) as $item)
												    <li role="presentation" class="active"><a href="{{ route('listing', ['sub_category_id' => $item->id]) }}" aria-controls="women1" role="tab" data-toggle="tab">{{ $item->sub_category }}</a></li>
												@endforeach
											</ul>
										</div>
									</div>
				...
				<div class="shop-the-look-banner">
					<div class="container">
						<div class="shop-the-look-banner-text">
							...
							<a href="#" class="shop-here">Shop Here</a>
						</div>
					</div>
				</div>
					...
					<div class="container">
						<div class="row">
							<div class="col-md-3 col-sm-6 col-xs-12">
								<div class="item-shop-the-look-post">
									<div class="inner-item-shop-post">
										<img src="images/home_3/b1.png" alt="" />
										<div class="item-shop-post-text">
											<h2>Collection Me’n</h2>
											<a href="#">shop now</a>
										</div>
									</div>
								</div>
							...
							<div class="col-md-3 col-sm-6 col-xs-12">
								<div class="item-shop-the-look-post">
									<div class="inner-item-shop-post">
										<img src="images/home_3/b2.png" alt="" />
										<div class="item-shop-post-text">
											<h2>Collection Me’n</h2>
											<a href="#">shop now</a>
										</div>
							...
							<div class="col-md-3 col-sm-6 col-xs-12">
								<div class="item-shop-the-look-post">
									<div class="inner-item-shop-post">
										<img src="images/home_3/b3.png" alt="" />
										<div class="item-shop-post-text">
											<h2>Collection Me’n</h2>
											<a href="#">shop now</a>
										</div>
							...
							<div class="col-md-3 col-sm-6 col-xs-12">
								<div class="item-shop-the-look-post">
									<div class="inner-item-shop-post">
										<img src="images/home_3/b4.png" alt="" />
										<div class="item-shop-post-text">
											<h2>Collection Me’n</h2>
											<a href="#">shop now</a>
										</div>
							...
							<div class="col-md-3 col-sm-6 col-xs-12">
								<div class="item-shop-the-look-post">
									<div class="inner-item-shop-post">
										<img src="images/home_3/b5.png" alt="" />
										<div class="item-shop-post-text">
											<h2>Collection Me’n</h2>
											<a href="#">shop now</a>
										</div>
							...
							<div class="col-md-3 col-sm-6 col-xs-12">
								<div class="item-shop-the-look-post">
									<div class="inner-item-shop-post">
										<img src="images/home_3/b6.png" alt="" />
										<div class="item-shop-post-text">
											<h2>Collection Me’n</h2>
											<a href="#">shop now</a>
										</div>
							...
							<div class="col-md-3 col-sm-6 col-xs-12">
								<div class="item-shop-the-look-post">
									<div class="inner-item-shop-post">
										<img src="images/home_3/b7.png" alt="" />
										<div class="item-shop-post-text">
											<h2>Collection Me’n</h2>
											<a href="#">shop now</a>
										</div>
							...
							<div class="col-md-3 col-sm-6 col-xs-12">
								<div class="item-shop-the-look-post">
									<div class="inner-item-shop-post">
										<img src="images/home_3/b8.png" alt="" />
										<div class="item-shop-post-text">
											<h2>Collection Me’n</h2>
											<a href="#">shop now</a>
										</div>
						...
						<div class="col-md-4 col-sm-12 col-xs-12">
							<div class="left-footer">
								...
								<div class="contact-footer">
									...
									<p><i class="fa fa-home"></i> Our business address is 1063 Freelon Street San Francisco, CA 95108</p>
									<p><i class="fa fa-tablet"></i> + 020.566.6666</p>
									<p><i class="fa fa-envelope"></i> support@7uptheme.com</p>
								</div>
							</div>
						</div>
				...
				<div class="container">
					<div class="row">
						<div class="col-md-6 col-sm-7 col-xs-12">
							<p class="info-copyright">Canifa © 2015 Wordpress Demo Store. All Rights Reserved. </p>
							<p class="info-copyright">Designed by 7-Up</p>
						</div>
