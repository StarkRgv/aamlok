            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="btn-popup pull-right">
                        <button type="button" class="btn btn-primary" data-toggle="modal" data-original-title="test" data-target="#catModal">Add Category</button>
                    ...
                    <table class="table">
                        ...
                        <tr>
                            ...
                            {{-- <td><a href="{{ route('category.destroy', ['category' => $category]) }}">Delete</a></td> --}}
                        </tr>
                        @endforeach
                        </tbody>
                    </table>
