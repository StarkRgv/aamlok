            ...
            <div class="card">
                ...
                <div class="card-body">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="form">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control @error('brand') is-invalid @enderror" id="validationCustom01" type="text" name="brand" value="" >
                                                @error('brand')
                    ...
                    <table class="table">
                        ...
                        {{-- Edit Modal --}}
                        <div class="modal fade" id="editModal_{{ $brand->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
