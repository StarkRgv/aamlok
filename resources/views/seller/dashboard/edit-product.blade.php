...
<div class="col-xl-7">
<form action="{{  route('update.product', ['product' => $product]) }}" method="POST" class="needs-validation add-product-form" enctype="multipart/form-data">
    @csrf
    <div class="form">
        ...
        <div class="form-group row">
            ...
            <select class="form-control @error('gender_id') is-invalid @enderror digits col-xl-8 col-sm-7" id="gender" name="gender_id">
        ...
        <div class="form-group mb-3 row">
            ...
            <input class="form-control @error('style_name') is-invalid @enderror col-xl-8 col-sm-7 " id="style_name" type="text" name="style_name" value="{{ $product->style_name }}">
                @error('style_name')
                    <div class="col-md-6 offset-md-3 text-danger">{{ $message }}</div>
                @enderror
        </div>
        <div class="form-group mb-3 row">
            ...
            <input class="form-control col-xl-8 col-sm-7 " id="department" type="text" name="department" value="{{ $product->department }}">
        </div>
        <div class="form-group mb-3 row">
            <label for="pattern" class="col-xl-3 col-sm-4 mb-0">Pattern:</label>
            <input class="form-control @error('pattern') is-invalid @enderror col-xl-8 col-sm-7" id="pattern" type="text" name="pattern" value="{{ $product->pattern }}">
                @error('pattern')
                    <div class="col-md-6 offset-md-3 text-danger">{{ $message }}</div>
                @enderror
        </div>
        <div class="form-group mb-3 row">
            ...
            <input class="form-control col-xl-8 col-sm-7" id="rise_style" type="text" name="rise_style" value="{{ $product->rise_style }}">
        </div>
        <div class="form-group mb-3 row">
            <label for="fitting_type" class="col-xl-3 col-sm-4 mb-0">Fitting Type:</label>
            <input class="form-control col-xl-8 col-sm-7" id="fitting_type" type="text" name="fitting_type" value="{{ $product->fitting_type }}">
        </div>
        <div class="form-group mb-3 row">
            <label for="fabric_type" class="col-xl-3 col-sm-4 mb-0">Fabric Type:</label>
            <input class="form-control col-xl-8 col-sm-7" id="fabric_type" type="text" name="fabric_type" value="{{ $product->fabric_type }}">
        </div>
        <div class="form-group mb-3 row">
            <label for="origin_country" class="col-xl-3 col-sm-4 mb-0">Country of Origin:</label>
            <input class="form-control @error('origin_country') is-invalid @enderror col-xl-8 col-sm-7" id="origin_country" type="text" name="origin_country" value="{{ $product->origin_country }}">
        ...
        <div class="form-group mb-3 row">
            ...
            <input class="form-control @error('mrp') is-invalid @enderror col-xl-8 col-sm-7" id="mrp" type="text" name="mrp" value="{{ $product->mrp }}">
                @error('mrp')
                    <div class="col-md-6 offset-md-3 text-danger">{{ $message }}</div>
                @enderror
        </div>
        <div class="form-group mb-3 row">
            ...
            <input class="form-control @error('selling_price') is-invalid @enderror col-xl-8 col-sm-7" id="selling_price" type="text" name="selling_price" value="{{ $product->selling_price }}">
                @error('selling_price')
                    <div class="col-md-6 offset-md-3 text-danger">{{ $message }}</div>
                @enderror
        </div>
        <div class="form-group mb-3 row">
            ...
            <input class="touchspin" id="order_quantity" type="text" name="order_quantity" value="{{ $product->order_quantity }}">
            </div>
            </fieldset>
        </div>
        <div class="form-group mb-3 row">
            ...
            <fieldset class="qty-box col-xl-9 col-xl-8 col-sm-7 pl-0">
            <div class="input-group">
            <input class="touchspin" id="pocket_count" type="text" name="pocket_count" value="{{ $product->pocket_count }}">
            </div>
        </fieldset>
        </div>
        <div class="form-group mb-3 row">
            ...
            <fieldset class="qty-box col-xl-9 col-xl-8 col-sm-7 pl-0">
                <div class="input-group">
            <input class="touchspin" id="unit_count" type="text" name="unit_count" value="{{ $product->unit_count }}">
                </div>
                </fieldset>
        ...
        <div class="form-group mb-3 row">
            ...
            <input class="form-control @error('manufacturer') is-invalid @enderror col-xl-8 col-sm-7" id="manufacturer" type="text" name="manufacturer" value="{{ $product->manufacturer }}">
                @error('manufacturer')
                    <div class="col-md-6 offset-md-3 text-danger">{{ $message }}</div>
                @enderror
        </div>
        <div class="form-group row">
            ...
            <div class="col-xl-8 col-sm-7 pl-0 description-sm">
                <textarea id="" name="care_instructions" class="form-control" cols="92" rows="4">{{ $product->care_instructions }}</textarea>
            </div>
        </div>
        <div class="form-group row">
            <label class="col-xl-3 col-sm-4">Occasion Instructions :</label>
            <div class="col-xl-8 col-sm-7 pl-0 description-sm">
                <textarea id="" class="form-control" name="occasion_instructions" cols="92" rows="4">{{ $product->occasion_instructions }}</textarea>
            </div>
        </div>
        <div class="form-group row">
            <label class="col-xl-3 col-sm-4">Material Composition :</label>
            <div class="col-xl-8 col-sm-7 pl-0 description-sm">
                <textarea id="" class="form-control" name="material_composition" cols="92" rows="4">{{ $product->material_composition }}</textarea>
            </div>
        </div>
        <div class="form-group row">
            <label class="col-xl-3 col-sm-4">Item Length Description :</label>
            <div class="col-xl-8 col-sm-7 pl-0 description-sm">
                <textarea id="" class="form-control" name="item_length_desc" cols="92" rows="4">{{ $product->item_length_desc }}</textarea>
            </div>
        </div>
        <div class="form-group row">
