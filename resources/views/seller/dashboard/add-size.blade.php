            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="btn-popup pull-right">
                        <button type="button" class="btn btn-primary" data-toggle="modal" data-original-title="test" data-target="#sizeModal">Size<i class="fa fa-plus" aria-hidden="true"></i></button>
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form class="needs-validation" action="{{ route('size.store') }}" method="POST">
                                            @csrf
                                        <div class="form">
                                            <div class="form-group">
                                                <label for="validationCustom01" class="mb-1">Size Name :</label>
                                                <input class="form-control @error('size') is-invalid @enderror" id="validationCustom01" type="text" name="size" value="" >
                                                @error('size')
                        ...
                        <div class="modal fade" id="editModal_{{ $size->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form class="needs-validation" action="{{ route('size.update', ['size' => $size]) }}" method="POST">
                                            @csrf
                                            <input type="hidden" name="_method" value="PUT">
                                        <div class="form">
                                            <div class="form-group">
                                                <label for="validationCustom01" class="mb-1">Size Name :</label>
                                                <input class="form-control @error('size') is-invalid @enderror" id="validationCustom01" type="text" name="size" value="{{ $size->size }}" >
                                                @error('size')
                                                    <div class="text-danger">{{ $message }}</div>
                                                @enderror
                                            </div>
